...
use QuantaQuirk\Queue\Connectors\BeanstalkdConnector;
use QuantaQuirk\Queue\Connectors\DatabaseConnector;
use QuantaQuirk\Queue\Connectors\NullConnector;
use QuantaQuirk\Queue\Connectors\RedisConnector;
use QuantaQuirk\Queue\Connectors\SqsConnector;
use QuantaQuirk\Queue\Connectors\SyncConnector;
use QuantaQuirk\Queue\Failed\DatabaseFailedJobProvider;
use QuantaQuirk\Queue\Failed\DatabaseUuidFailedJobProvider;
use QuantaQuirk\Queue\Failed\DynamoDbFailedJobProvider;
use QuantaQuirk\Queue\Failed\FileFailedJobProvider;
use QuantaQuirk\Queue\Failed\NullFailedJobProvider;
...
class QueueServiceProvider extends ServiceProvider implements DeferrableProvider
{
     ...
     *
     * @param  \QuantaQuirk\Queue\QueueManager  $manager
     * @return void
     */
     ...
     *
     * @param  array  $config
     * @return \QuantaQuirk\Queue\Failed\DatabaseFailedJobProvider
     */
     ...
     *
     * @param  array  $config
     * @return \QuantaQuirk\Queue\Failed\DatabaseUuidFailedJobProvider
     */
     ...
     *
     * @param  array  $config
     * @return \QuantaQuirk\Queue\Failed\DynamoDbFailedJobProvider
     */
