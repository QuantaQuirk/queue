...
use QuantaQuirk\Contracts\Cache\Repository as CacheContract;
use QuantaQuirk\Contracts\Debug\ExceptionHandler;
use QuantaQuirk\Contracts\Events\Dispatcher;
use QuantaQuirk\Contracts\Queue\Factory as QueueManager;
use QuantaQuirk\Database\DetectsLostConnections;
...
use QuantaQuirk\Queue\Events\JobReleasedAfterException;
use QuantaQuirk\Queue\Events\JobTimedOut;
use QuantaQuirk\Queue\Events\Looping;
use QuantaQuirk\Queue\Events\WorkerStopping;
...
class Worker
{
     ...
     *
     * @param  \QuantaQuirk\Contracts\Queue\Factory  $manager
     * @param  \QuantaQuirk\Contracts\Events\Dispatcher  $events
     * @param  \QuantaQuirk\Contracts\Debug\ExceptionHandler  $exceptions
     ...
     * @param  string  $queue
     * @param  \QuantaQuirk\Queue\WorkerOptions  $options
     * @return int
     */
     ...
     *
     * @param  \QuantaQuirk\Contracts\Queue\Job|null  $job
     * @param  \QuantaQuirk\Queue\WorkerOptions  $options
     * @return void
     */
     ...
     *
     * @param  \QuantaQuirk\Contracts\Queue\Queue  $connection
     * @param  string  $queue
     * @return \QuantaQuirk\Contracts\Queue\Job|null
     */
    ...
    {
        if ($this->cache) {
            return $this->cache->get('quantaquirk:queue:restart');
        }
    }
     ...
     *
     * @param  int  $status
     * @param  \QuantaQuirk\Queue\WorkerOptions|null  $options
     * @return never
     */
     ...
     *
     * @param  \QuantaQuirk\Contracts\Queue\Job  $job
     * @return \QuantaQuirk\Queue\MaxAttemptsExceededException
     */
     ...
     *
     * @param  \QuantaQuirk\Contracts\Queue\Job  $job
     * @return \QuantaQuirk\Queue\TimeoutExceededException
     */
     ...
     *
     * @return \QuantaQuirk\Contracts\Queue\Factory
     */
