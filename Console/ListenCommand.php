...
class ListenCommand extends Command
{
     ...
     *
     * @var \QuantaQuirk\Queue\Listener
     */
    protected $listener;
     ...
     *
     * @param  \QuantaQuirk\Queue\Listener  $listener
     * @return void
     */
    ...
    {
        $connection = $connection ?: $this->quantaquirk['config']['queue.default'];

        return $this->input->getOption('queue') ?: $this->quantaquirk['config']->get(
     ...
     *
     * @return \QuantaQuirk\Queue\ListenerOptions
     */
