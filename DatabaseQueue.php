...
use QuantaQuirk\Contracts\Queue\ClearableQueue;
use QuantaQuirk\Contracts\Queue\Queue as QueueContract;
use QuantaQuirk\Database\Connection;
use QuantaQuirk\Queue\Jobs\DatabaseJob;
use QuantaQuirk\Queue\Jobs\DatabaseJobRecord;
...
class DatabaseQueue extends Queue implements QueueContract, ClearableQueue
{
     ...
     *
     * @param  \QuantaQuirk\Database\Connection  $database
     * @param  string  $table
     ...
     *
     * @param  string  $queue
     * @param  \QuantaQuirk\Queue\Jobs\DatabaseJobRecord  $job
     * @param  int  $delay
     * @return mixed
     */
     ...
     *
     * @param  string|null  $queue
     * @return \QuantaQuirk\Queue\Jobs\DatabaseJobRecord|null
     */
     ...
     *
     * @param  \QuantaQuirk\Database\Query\Builder  $query
     * @return void
     */
     ...
     * @param  string  $queue
     * @param  \QuantaQuirk\Queue\Jobs\DatabaseJobRecord  $job
     * @return \QuantaQuirk\Queue\Jobs\DatabaseJob
     */
     ...
     *
     * @param  \QuantaQuirk\Queue\Jobs\DatabaseJobRecord  $job
     * @return \QuantaQuirk\Queue\Jobs\DatabaseJobRecord
     */
     ...
     *
     * @param  string  $queue
     * @param  \QuantaQuirk\Queue\Jobs\DatabaseJob  $job
     * @param  int  $delay
     * @return void
     */
